...
/*
 * NOTAR QUE ESTA FUNCION AGRUPA LOS TRIES QUE SE UTILIZAN EN EL SISTEMA.
 * EN CADA CASO SE DEBE INDICAR COMO "CODIGOTRIE" UN INDICADOR QUE
 * ESPECIFIQUE CUAL DEBE UTILIZARSE. LOS INDICADORES SON:
 * IMAGENES; MENSAJES; DIRECTORIOS
 */
