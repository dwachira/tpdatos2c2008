...
if(STEGO_BASICO) return LSBStegoBusiness::changePixel(pixels,mensaje,size);
...
if(STEGO_BASICO) return LSBStegoBusiness::getMessageFromPixel(pixels,longitud);
